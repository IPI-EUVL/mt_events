...
class Awaiter:
    ...
    def __init__(self):
        ...
        self.__do_fail = (False, [], {})

    def do_fail(self, *pargs, **kwargs):
        """
        Used if the awaiter is bound to fail, will make the awaiter call catch function immediately after it is registered.
        """

        self.__do_fail = (True, list(pargs), dict(kwargs))
    ...
    def catch(self, fn, pargs: list | None = None, kwargs: dict | None = None):
        ...
        if self.__do_fail[0]:
            self.throw(*self.__do_fail[1], **self.__do_fail[2])
